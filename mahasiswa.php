...
<div class="container">
        ...
        <a href="index.php?p=mhs&page=input" class="btn btn-primary mb-3">Input Data Mahasiswa</a>
            ...
            <table class="table table-bordered">
                ...
                <?php
                    include 'koneksi.php';
                    $ambil = mysqli_query($db,"SELECT * FROM mahasiswa INNER JOIN 
            ...
            <form action="proses_mhs.php?aksi=create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select name="prodi" class="form-select">
                        ...
                        ?>
                        <option value="<?= $data_prodi['prodi_id']?>"><?=$data_prodi['nama_prodi']?></option>
                        <?php
                            }
                        ?>
                    </select>
        ...
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <?php
                    $prodi=mysqli_query($db,"SELECT * FROM prodi");
                        while($data_prodi=mysqli_fetch_array($prodi)){
                            $terpilih=($data['prodi_id']==$data_prodi['prodi_id']) ? 'selected' : '';
                        ?>
                        <option value="<?= $data_prodi['prodi_id']?>"<?= $terpilih ?>> <?=$data_prodi['nama_prodi']?></option>
                        <?php
                        }
                        ?>
                </select>
            ...
            <div class="mb-2">
                <label class="form-label">Hobi</label>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="hobi[]" value="Sholawat" <?php if (in_array('Sholawat',$hobies)) echo 'checked'?> >
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="hobi[]" value="Mengaji" <?php if (in_array('Mengaji',$hobies)) echo 'checked'?>>
                    <label class="form-check-label" for="flexCheckChecked">
                    Olahraga
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="hobi[]" value="Memasak" <?php if (in_array('Memasak',$hobies)) echo 'checked'?>> 
